                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-24">
                        ...
                        <div v-else-if="!isParticipating && challenge.is_expired" class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Desafio encerrado</h3>
                            <p class="text-gray-600 text-sm mb-4">
                                Este desafio já terminou e não aceita novas participações.
                            </p>

                            <button disabled
                                class="w-full bg-gray-300 text-gray-600 px-4 py-3 rounded-lg font-semibold cursor-not-allowed">
                                Encerrado
                            </button>

                            <p class="text-xs text-gray-500 mt-3">
                                Você ainda pode ver o conteúdo como histórico e referência.
                            </p>
                        </div>
